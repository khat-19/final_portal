...
if(isset($_POST['search'])) {
  ...
  $sql .= "WHERE passFirstName = '{$search_term}'";
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="-group">
              ...
              <form action="buttons.php" method="POST" name="search_form" >
      ...
      <div class="main-panel">          
                  ...
                  <div class="col">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="display-6 text-center">Daily Arrivals</h4>
                      </div>
                      <div class="card-body">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://www.bootstrapdash.com/" target="_blank">Point of Entry</a><?php echo date('Y') ?></span>
