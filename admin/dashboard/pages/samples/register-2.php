            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal">mawuliwh
                  </h6>
              ...
              <a class="dropdown-item">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal">Rampage
                  </h6>
                  <p class="font-weight-light small-text text-muted mb-0">
                    New product launch
                  </p>
              ...
              <a class="dropdown-item">
                ...
                <div class="item-content flex-grow">
                  <h6 class="ellipsis font-weight-normal"> Alpha
                  </h6>
                  <p class="font-weight-light small-text text-muted mb-0">
          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="row">
                  <div class="col-md-6">
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum veritatis, debitis consequatur ipsa ipsum quidem, quasi odit architecto, earum distinctio unde culpa. Dolores ut ab, soluta quas natus sit expedita?
                 Praesentium blanditiis similique necessitatibus maxime, suscipit dolorum unde sed nisi ab numquam recusandae obcaecati vel officia laboriosam nobis magni beatae laudantium aspernatur labore voluptatum iste sequi quaerat nemo! Sed, dolorem.
                 Modi nostrum veritatis sint culpa laudantium suscipit perspiciatis voluptas debitis nisi doloremque inventore sed, voluptates quis exercitationem impedit officiis fuga consectetur cupiditate iste aperiam necessitatibus numquam itaque accusantium reiciendis! Facilis?
                 Soluta, iure! In blanditiis corporis sed recusandae nulla tenetur illo rerum doloremque quae porro perferendis molestias incidunt mollitia hic perspiciatis placeat adipisci temporibus reiciendis, iure quibusdam. Excepturi consequuntur ipsa est.</p>
                  </div>
                </div>
              </div>
            </div>
