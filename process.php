...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO arrival VALUES ('', '$location', '$travcount', '$flightname', '$passportnum', '$seatnum', '$traveldate', '$passFirstName', '$passMiddleName', '$passLastName', '$gender', '$localNumber', '$permNumber', '$purposeoftravel', '$numnStreetName', '$appartmentNumber', '$city', '$email', '$distStateProvince', '$hotelName', '$numStreetNamea', '$districtCity', '$fever', '$weaknessFatigue', '$coughing', '$achesPain', '$bleedingBrusing', '$headaches', '$vommitingDiarrhoea', '$difficultBreath', '$yellowEyes', '$emmFirstName','$emmMiddleName', '$emmLastName', '$emmCity', '$emmCountry', '$emmPhoneNumber', '$emmEmail', '$emmTemperature')";
